...
- **Boyut tutarlılığı (2026-07-23):** tema değişince YALNIZ font karakteri değişir, boyut değişmez. İki mekanizma: (1) her `@font-face`'te `size-adjust` — fontların iç ölçüleri farklı olduğu için (Alegreya Sans %8 küçük, Metamorphous %7 büyük çizerdi) hepsi Segoe UI hedefine normalize edildi: Oxanium 101%, Metamorphous 94%, Rajdhani 102%, Alegreya Sans 108%. (2) Tüm metin öğelerinde sabit sayısal `line-height` — `normal` fontun kendi metriğinden geldiği için buton boyu temaya göre 77→75→73px oynuyordu. **Yeni font eklerken:** fontTools ile x/cap yüksekliğini ölç, size-adjust hesapla; yeni metin öğesine mutlaka `line-height` ver.
